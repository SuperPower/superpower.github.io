...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b4b37acb1547561434900479de69ee5af6783954db53e63d2ccca450db68a4ec.js',function(){input.required=false;search();});}
