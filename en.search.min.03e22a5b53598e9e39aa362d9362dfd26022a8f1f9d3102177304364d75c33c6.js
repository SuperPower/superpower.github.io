...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f0806cd4ce4a357041a1e325900c4f0491934973fe4d7acb762413cb6ff29272.js',function(){input.required=false;search();});}
