...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.796bf8bcb1522eca6c0401dda083e5a537a35321d3a0700aa471056fb0582777.js',function(){input.required=false;search();});}
