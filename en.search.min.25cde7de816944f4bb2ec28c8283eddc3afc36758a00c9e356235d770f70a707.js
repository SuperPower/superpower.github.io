...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.fc39d4a06c8b3cae931dab6d9f8add78ed2973ca75b4e63dd787c75e9c3283ed.js',function(){input.required=false;search();});}
