...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.34f2202cb6e4d44f0b5992a36fe2efba8794813a3977ae4a9b5ef06fc41d997f.js',function(){input.required=false;search();});}
