...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8014cef4ea2728d1fae541cba810e2f16ffe87d80bc98c3f05c0fb2d498c38a2.js',function(){input.required=false;search();});}
