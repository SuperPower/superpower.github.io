...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4887caca69de11fa1d83c3906a9c093a5cc84d57af3cdaf2a998f8f06469b2d1.js',function(){input.required=false;search();});}
